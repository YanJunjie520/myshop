            ...
            <div class="details">
                ...
                <div>
                    <ul>
                        ...
                        <li>市场价格：￥<i class="style_red">${product.pprice}</i></li>
                        <li>上市时间：${product.ptime}</li>
                        <li>热销指数：<div class="bar">
                            <div class="bar_in" style="width: ${product.pstate * 20}%"></div>
                        </div>
                        </li>
                        <li>详细介绍：</li>
                        <li>${product.pinfo}</li>
                        <li>
                            <a href="cart?method=create&pid=${product.pid}" class="btn1">加入购物车&nbsp;&nbsp;</a>
                            <input type="button" value="直接购买" class="btn2">
                        </li>
                    </ul>
                </div>
            </div>
