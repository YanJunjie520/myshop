...
<head>
    ...
    <title>订单详情页-综合网购首选-正品低价、品质保障、配送及时、轻松购物!
    </title>
    <!-- 网站说明 -->
            ...
            <ul>
                ...
                <li>
                    <ul class="row2 clearfix">
                        <li>收件人：</li>
                        <li>${orders.address.aname}</li>
                        <li>联系电话：</li>
                        <li>${orders.address.aphone}</li>
                    </ul>
                </li>
                <li>
                    <ul class="row3 clearfix">
                        <li>送货地址：</li>
                        <li>${orders.address.adetail}</li>
                        <li>总价：</li>
                        <li>￥${orders.ocount}</li>
                    </ul>
                </li>
                        ...
                        <li class="clearfix">
                            ...
                            <div>
                                <table>
                                    ...
                                    <c:forEach items="${orders.itemList}" var="item" varStatus="status">
                                        <tr>
                                            <td>${status.count}</td>
                                            <td>${item.product.pname}</td>
                                            <td>${item.product.ptime}</td>
                ...
                <li>
                    <ul class="row5 clearfix">
                        <li><a href="orders?method=pay&oid=${orders.oid}">付款</a><a href="orders?method=show">返回订单列表</a></li>
                    </ul>
                </li>
            </ul>
        </div>
