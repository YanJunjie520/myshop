        ...
        <div class="fr">
            <ul>
                <c:if test="${empty loginUser}">
                    ...
                    <li></li>
                    <li><a href="register.html" class="style_red">注册</a></li>
                </c:if>
                <c:if test="${not empty loginUser}">
                    <li><a href="userAddress?flag=show">${loginUser.uname}</a></li>
                    <li></li>
                    <li><a href="user?method=logOut">注销</a></li>
                    <li></li>
                    <li><a href="getOrderList">我的订单</a></li>
                    <li></li>
                    <li><a href="userServlet?method=getAddress">地址管理</a></li>
                </c:if>
            </ul>
        </div>
    </div>
