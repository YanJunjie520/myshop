...
<div class="sk_container w">
    ...
    <div class="sk_bd">
        <c:if test="${empty ordersList}">
            <h3 style="color: #000; font-size: 22px; font-weight: 400;">没有任何销售记录......</h3>
        </c:if>
        <c:if test="${not empty ordersList}">
            <table>
                ...
                <c:forEach items="${ordersList}" var="orders" varStatus="o">
                    <c:forEach items="${orders.itemList}" var="item" varStatus="i">
                        <tr>
                            ...
                            <c:if test="${orders.ostate == 3}">
                                <td style="color: green">已收获，待评价</td>
                            </c:if>
                            <c:if test="${orders.ostate == 4}">
                                <td style="color: hotpink">已评价</td>
                            </c:if>
                            <c:if test="${orders.ostate == 5}">
