...
<head>
    ...
    <script type="text/javascript">
        function deleteProduct(pid) {
            if(confirm("确定从商品目录中删除该商品？")) {
                location.href = "product?method=delete&pid=" + pid;
            }
        }
        function modifyProduct(pid) {
            location.href = "product?method=modify&pid=" + pid;
        }
    </script>
</head>
            ...
            <ul>
                    ...
                    <table>
                        ...
                        <c:forEach items="${productList}" var="product" varStatus="status">
                            <tr>
                                ...
                                <td>${product.pinfo}</td>
                                <td>
                                    <button class="delete" onclick="deleteProduct(${product.pid})">删除</button>
                                    <button class="modify" onclick="modifyProduct(${product.pid})">修改</button>
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <li>
                    <form action="product?method=add" method="post">
                        <ul>
                            <li><label>类别<i style="color: transparent;">隐形隐形</i></label><input type="text" name="tname"></li>
                            <li><label>商品名称<i style="color: transparent;">隐形</i></label><input type="text" name="pname"></li>
                            <li><label>商品图片路径</label><input type="text" name="pimage"></li>
                            <li><label>商品单价<i style="color: transparent;">隐形</i></label><input type="text" name="pprice"></li>
                            <li><label>商品详细介绍</label></li>
                            <li><textarea name="pinfo"></textarea></li>
                            <li><input type="submit" class="add" value="添加商品"></li>
                        </ul>
                    </form>
                </li>
            </ul>
