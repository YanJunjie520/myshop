...
<head>
    ...
    <link rel="stylesheet" href="css/self_info_modify.css">
...
<div class="sk_container w">
    <div class="sk_bd">
        <div>
            <h3 class="top">修改信息</h3>
            <form action="address?method=modifyAddress" method="post">
                <div class="center">
                    <ul>
                        <li><label class="addressee">收件人</label>
                            <input type="hidden" name="aid" value="${addr.aid}">
                            <input type="text" name="aname" value="${addr.aname}">
                        </li>
                        <li><label class="phone">手机号</label><input type="text" name="aphone" value="${addr.aphone}"></li>
                        <li><label class="detail_address">详细地址</label></li>
                        <li><textarea name="adetail">${addr.adetail}</textarea></li>
                        <li>
                            <input type="submit" class="btn1" value="修改收货信息">
                            <a href="address?method=show" class="btn2">返回个人主页</a>
                        </li>
                    </ul>
                </div>
            </form>
